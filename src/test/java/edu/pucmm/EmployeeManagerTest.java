...
public class EmployeeManagerTest {
    ...
    public void testCalculateTotalSalary() {
        ...
        assertEquals(employeeManager.calculateTotalSalary(), expectedTotalSalary);
    }
    ...
    public void testAddEmployeeWithInvalidSalary() {
        ...
        // - Verificar que se lanza una InvalidSalaryException al agregar este empleado.
        try {
            Employee invalidEmployee1 = new Employee("3", "Fernandito Villalona", juniorDeveloper, 60000);
            employeeManager.addEmployee(invalidEmployee1);
        } catch (InvalidSalaryException e) {
            assertTrue(true);
        }

        try {
            Employee invalidEmployee2 = new Employee("4", "Juan Luis Guerra", seniorDeveloper, 40000);
            employeeManager.addEmployee(invalidEmployee2);
        } catch (InvalidSalaryException e) {
            assertTrue(true);
        }
    }
